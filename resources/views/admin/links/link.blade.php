                ...
                <div class="col-lg-12">
                    <section class="panel">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="friendLink" method="post">
                                                {{ csrf_field() }}
                                                ...
                                                <div class="form-group">
                                                    <label for="recipient-name" class="control-label">图片/文字:</label>
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                <th> 名称 </th>
                                <th class="hidden-phone"> 图片/文字 </th>
                                <th> 地址 </th>
                                <th> 操作 </th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td>12120.00$</td>
                                <td>
                                    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#exampleModall" data-whatever="@mdo"><i class="icon-pencil"></i></button>
